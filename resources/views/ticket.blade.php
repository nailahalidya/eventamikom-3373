        ...
        <div class="bg-white text-slate-900 rounded-[2.5rem] overflow-hidden shadow-2xl relative border border-slate-100">
            ...
            <div class="p-8 space-y-8">
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        <p class="text-slate-400 text-[10px] font-bold uppercase mb-1">
                            Nama Pembeli
                        </p>
                    ...
                    <div>
                        ...
                        <p class="font-bold text-slate-800 font-mono text-sm">
                ...
                <div class="bg-slate-50 p-6 rounded-3xl flex flex-col items-center border border-slate-100">
                    <p class="text-slate-400 text-[10px] font-bold uppercase mb-4 tracking-widest">
                    ...
                    <p class="mt-4 font-mono font-bold text-slate-600 text-xs">
                        TKT-{{ $transaction->id }}-{{ strtoupper(substr($transaction->order_id, -5)) }}
                    </p>
                </div>
            </div>
            ...
            <div class="px-8 pb-8 space-y-3">
                <button onclick="window.print()"
                        class="w-full py-4 bg-indigo-600 text-white rounded-2xl font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-0.5 transition-all">
                    Cetak / Simpan PDF
                </button>
