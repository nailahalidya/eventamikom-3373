        ...
        <form action="{{ route('admin.events.store') }}"
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <div id="no-tiers-message" class="rounded-xl border border-dashed border-slate-200 bg-slate-50 p-4 text-slate-500 text-sm text-center {{ !empty($tierRows) ? 'hidden' : '' }}">
